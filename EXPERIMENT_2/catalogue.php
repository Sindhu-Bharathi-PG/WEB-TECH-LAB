...
<body>
    ...
    <div class="main-content">
        ...
        <div class="book-cards-grid">
            <div class="book-card">
                <div class="book">
                    <img src="assets/one.webp" alt="the cast of Schitt’s Creek">
                </div>
                <div class="details">
                    <h5>J.K. Rowling</h5>
                    <p>Bloomsbury</p>
                    <p class="price">₹499</p>
                    <button class="btn btn-cart"><i class="bi bi-cart-plus me-1"></i>Add to Cart</button>
                </div>
            </div>

            <div class="book-card">
                <div class="book">
                    <img src="assets/dream.webp" alt="Elektra Wintour from Pose">
                </div>
                <div class="details">
            ...
            <div class="book-card">
                <div class="book">
                    <img src="assets/soul.webp" alt="Janet from The Good Place">
                </div>
                <div class="details">
                    <h5>Dan Brown</h5>
                    <p>Random House</p>
        ...
        <div class="book-cards-grid">
            <div class="book-card">
                <div class="book">
                    <img src="assets/book1.webp" alt="the cast of Schitt’s Creek">
                </div>
                <div class="details">
                    <h5>J.K. Rowling</h5>
                    <p>Bloomsbury</p>
            ...
            <div class="book-card">
                <div class="book">
                    <img src="assets/book2.jpg" alt="Elektra Wintour from Pose">
                </div>
                <div class="details">
                    <h5>George R.R. Martin</h5>
                    <p>Bantam Books</p>
            ...
            <div class="book-card">
                <div class="book">
                    <img src="assets/book3.webp" alt="Janet from The Good Place">
                </div>
                <div class="details">
                    <h5>Dan Brown</h5>
                    <p>Random House</p>
        ...
        <div class="book-cards-grid">
            <div class="book-card">
                <div class="book">
                    <img src="assets/book4.jpg" alt="the cast of Schitt’s Creek">
                </div>
                <div class="details">
                    <h5>J.K. Rowling</h5>
                    <p>Bloomsbury</p>
            ...
            <div class="book-card">
                <div class="book">
                    <img src="assets/book5.webp" alt="Elektra Wintour from Pose">
                </div>
                <div class="details">
                    <h5>George R.R. Martin</h5>
                    <p>Bantam Books</p>
            ...
            <div class="book-card">
                <div class="book">
                    <img src="assets/book6.jpg" alt="Janet from The Good Place">
                </div>
                <div class="details">
                    <h5>Dan Brown</h5>
                    <p>Random House</p>
        ...
        <div class="book-cards-grid">
            <div class="book-card">
                <div class="book">
                    <img src="assets/book7.jpg" alt="the cast of Schitt’s Creek">
                </div>
                <div class="details">
                    <h5>J.K. Rowling</h5>
                    <p>Bloomsbury</p>
            ...
            <div class="book-card">
                <div class="book">
                    <img src="assets/book8.jpg" alt="Elektra Wintour from Pose">
                </div>
                <div class="details">
                    <h5>George R.R. Martin</h5>
                    <p>Bantam Books</p>
            ...
            <div class="book-card">
                <div class="book">
                    <img src="assets/book9.jpg" alt="Janet from The Good Place">
                </div>
                <div class="details">
                    <h5>Dan Brown</h5>
                    <p>Random House</p>
        ...
        <div class="book-cards-grid">
            <div class="book-card">
                <div class="book">
                    <img src="assets/book10.webp" alt="the cast of Schitt’s Creek">
                </div>
                <div class="details">
                    <h5>J.K. Rowling</h5>
                    <p>Bloomsbury</p>
            ...
            <div class="book-card">
                <div class="book">
                    <img src="assets/book11.jpg" alt="Elektra Wintour from Pose">
                </div>
                <div class="details">
                    <h5>George R.R. Martin</h5>
                    <p>Bantam Books</p>
